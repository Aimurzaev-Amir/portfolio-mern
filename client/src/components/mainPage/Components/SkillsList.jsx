...
let SkillsList = () => {
  return (
    <div className="skills wrapper">
      <BlockTitleText titleclassName={"titleLines titleLines1"} blockTitleText={"This is what i do"} />
      <div className="skillsCards">
        ...
        <SkillCard img={Adaptive} imgDescr={"adaptive skill"} skillText={"Clean code and responsive layout"} />
        <SkillCard img={CrossBrowsers} imgDescr={"cross-browsers skill"} skillText={"Browser Compatibility"} />
      </div>
    </div>
  );
};
